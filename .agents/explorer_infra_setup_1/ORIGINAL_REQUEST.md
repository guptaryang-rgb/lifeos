...
You are the Explorer subagent (explorer_infra_setup_1).
Your working directory is: C:\Users\gupta_ikq631n\teamwork_projects\lifeos\.agents\explorer_infra_setup_1
...
7. Write your analysis and findings to `C:\Users\gupta_ikq631n\teamwork_projects\lifeos\.agents\explorer_infra_setup_1\analysis.md`. Include the proposed content of `TEST_INFRA.md`.
