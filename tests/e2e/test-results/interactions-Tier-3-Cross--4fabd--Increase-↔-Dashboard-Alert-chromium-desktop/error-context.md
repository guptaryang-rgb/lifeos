...
- Name: interactions.spec.ts >> Tier 3: Cross-Feature Interactions >> XF-T5: Habit Streak Failure ↔ Burnout Score Increase ↔ Dashboard Alert
- Location: tests\interactions.spec.ts:151:7
